...
import { HorizontalTree } from '@/shared/components/horizontal-tree';
import { ProcessMap } from '@/features/processes/process-map';
import { Connectors } from '@/shared/components/connectors';
import { Chatbot, NAVIGATE_KNOWLEDGE_EVENT } from '@/shared/components/chatbot';
import { AuditLogsView } from '@/features/audit-logs/audit-logs-view';
import { DashboardsView } from '@/features/dashboards/dashboards-view';
