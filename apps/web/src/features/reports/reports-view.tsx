...
import { useOptimisticUpdateProcess, useCategoriesData } from '@/shared/hooks/use-app-data';
import * as XLSX from 'xlsx';
import { useUser } from '@/app/providers/UserContext';
import { ShareModal } from '@/shared/components/share-modal';
import { BUSINESS_OS_REPORT_FIELDS_KEY, LEGACY_NONPROFIT_OS_REPORT_FIELDS_KEY, getStoredValue, setStoredValue } from '@/shared/lib/storage';
...
const LS_KEY = BUSINESS_OS_REPORT_FIELDS_KEY;
...
function loadFieldConfig(): Record<ReportId, string[]> {
  try {
    const stored = getStoredValue(LS_KEY, LEGACY_NONPROFIT_OS_REPORT_FIELDS_KEY);
    if (stored) {
...
export function ReportsView() {
  ...
  function updateFields(newFields: string[]) {
    if (isBuiltInReport) {
      ...
      setStoredValue(LS_KEY, JSON.stringify(newConfig), LEGACY_NONPROFIT_OS_REPORT_FIELDS_KEY);
