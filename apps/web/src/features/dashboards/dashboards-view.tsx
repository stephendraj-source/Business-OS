...
import { useProcessesData, useAuditLogsData, useOptimisticUpdateProcess, useCategoriesData } from '@/shared/hooks/use-app-data';
import {
...
import { ShareModal } from '@/shared/components/share-modal';
import { BUSINESS_OS_DASHBOARD_WIDGETS_KEY, LEGACY_NONPROFIT_OS_DASHBOARD_WIDGETS_KEY, getStoredValue, setStoredValue } from '@/shared/lib/storage';
...
const LS_KEY = BUSINESS_OS_DASHBOARD_WIDGETS_KEY;
...
function loadWidgets(): WidgetConfig[] {
  try {
    const saved = getStoredValue(LS_KEY, LEGACY_NONPROFIT_OS_DASHBOARD_WIDGETS_KEY);
    if (saved) {
...
function saveWidgets(w: WidgetConfig[]) { setStoredValue(LS_KEY, JSON.stringify(w), LEGACY_NONPROFIT_OS_DASHBOARD_WIDGETS_KEY); }
